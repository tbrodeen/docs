...
<Steps>
  <Step title="Sign up">
    Visit [app.backvote.co/signup](https://app.backvote.co/signup) and create your account. You can sign up with email or use a magic link for passwordless login.
  </Step>
...
<Steps>
  ...
  <Step title="Share your campaign">
    Publish your campaign and grab the shareable link or QR code. Your campaign is live at `backvote.co/c/your-slug`.
  </Step>
</Steps>
